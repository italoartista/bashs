...
# Criação do arquivo SQL para a estrutura do banco de dados
cat > pim-project/schema.sql <<EOL
-- Tabelas
...
-- Tabela de valores de atributos de produtos
...
describe('GET /products', () => {
  it('should return all products', async () => {
    const products = [{ product_id: 1, name: 'Product 1', sku: 'SKU1' }];
